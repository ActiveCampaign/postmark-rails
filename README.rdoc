...
You can pass either an array of File objects or a single object. Postmark will detect file name automatically. Alternatively you can pass Hash objects, which is especially useful if you want to specify custom file name or content-type. Do it like that:
