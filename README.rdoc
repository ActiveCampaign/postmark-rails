...
=== Rails 3
    ...
    class TestMailer < ActionMailer::Base
      ...
      def message_with_attachment
        returning message = nil do
          message = mail(
            :subject => 'hello',
            :to      => 'sheldon@bigbangtheory.com',
            :from    => 'leonard@bigbangtheory.com'
          )
          message.postmark_attachments = [File.open("/path/to/file")]
        end
      end
...
You can pass either an array of File objects or a single object. Postmark will detect file name automatically. Alternatively you can pass Hash objects instead of File objects. That's especially useful if you want to specify custom file name or content-type. Do it like that:
